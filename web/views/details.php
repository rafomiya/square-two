...
<div class="container mb-3 mt-3">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm d-flex flex-column">
            <p class="text text-muted m-0"><?= $product['brand'] ?></p>
            <h1><?= $product['category'] . ' ' . $product['brand'] . ' ' . $product['model'] ?></h1>
            ...
            <section class="mt-auto">
                <p class="mb-0 fs-5 text-break"><strong>Marca:</strong> <a href="brand.php?b=<?= $product['id_brand'] ?>"><?= $product['brand'] ?></a></p>
                <p class="mb-0 fs-5 text-break"><strong>Modelo:</strong> <?= $product['model'] ?></p>
                <p class="mb-0 fs-5 text-break"><strong>Categoria:</strong> <a href="category.php?c=<?= $product['id_category'] ?>"><?= $product['category'] ?></a></p>
                <p class="mb-0 fs-5 text-break"><strong>Descrição:</strong> <?= $product['description'] ?></p>
            </section>
        </div>
